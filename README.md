...
Начнём с рассмотрения графика обучения для mnist. Если сравнить график для mnist, представленный до этого, то можно заметить, что удалось слегка улучшить качество на тесте на поздних эпохах. Переобучения как не было, так и не появилось.
