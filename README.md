...
![3dscatter_mnist_contracting_annotated.png](plots%2Fgrid_search%2F3dscatter_mnist_contracting_annotated.png)
 ...
 - При расширении слоёв лучший результат на обоих датасетах опять получается при наибольших количествах весов (256, 512, 1024). Так же на cifar10 можно выделить точку (128, 512, 1024). Она достаточна близка к максимальной точности.
